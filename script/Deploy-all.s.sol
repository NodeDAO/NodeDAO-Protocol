...
//         beaconOracle = new WithdrawOracle();
...
//         WithdrawOracle(beaconOracleProxy).initialize(_daoEOA, _genesisTime, address(vnftProxy));
...
//         WithdrawOracle(beaconOracleProxy).setLiquidStaking(address(liquidStakingProxy));

//         // BeaconOracle addOracleMember
//         for (uint256 i = 0; i < memberArray.length; ++i) {
//             WithdrawOracle(beaconOracleProxy).addOracleMember(memberArray[i]);
//         }
//     }
...
//         // BeaconOracle
//         WithdrawOracle(beaconOracleProxy).setDaoAddress(_daoMultisigContract);
...
//         // BeaconOracle
//         WithdrawOracle(beaconOracleProxy).transferOwnership(address(timelock));
