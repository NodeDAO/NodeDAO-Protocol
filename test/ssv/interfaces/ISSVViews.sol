...
interface ISSVViews is ISSVNetworkCore {
    ...
    function isLiquidatable(address owner, uint64[] memory operatorIds, Cluster memory cluster)
        external
        view
    ...
    function isLiquidated(address owner, uint64[] memory operatorIds, Cluster memory cluster)
        external
        view
    ...
    function getBurnRate(address owner, uint64[] memory operatorIds, Cluster memory cluster)
        external
        view
    ...
    function getBalance(address owner, uint64[] memory operatorIds, Cluster memory cluster)
        external
        view
